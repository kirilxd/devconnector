...
describe('User Model Test', () => {
    ...
    it('insert user successfully, but the field does not defined in schema should be undefined', async () => {
        const userWithInvalidField = new UserModel({ name: 'Kiril', email: 'hellowrld@gmail.com', password: 'qwerty'});
...
describe('Post Model Test', () => {
    ...
    it('insert post successfully, but the field does not defined in schema should be undefined', async () => {
        const postWithInvalidField = new PostModel({ handle: 'dadad', company: 'Apple', website: 'kpi.ua', location: 'Kyiv', status: 'online', text: 'dadsadas'});
...
describe('Profile Model Test', () => {
    ...
    it('insert profile successfully, but the field does not defined in schema should be undefined', async () => {
        const profileWithInvalidField = new ProfileModel({ handle: 'dadadada', status: 'online' });
    ...
    it('create profile without required field should failed', async () => {
        const profileWithoutRequiredField = new ProfileModel({ handle: 'dadadaad' });
        let err;
        try {
